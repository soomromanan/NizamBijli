											...
											<div class="form-group has-feedback" id="customer_cnic">
												...
												<div class="col-md-5">
													<input type="text" class="form-control mask cnic"
														...
														onchange="getCnic('cnicMsg')" data-parsley-trigger="blur"
														data-column="customer_cnic" data-table="customer"
														data-type="cnic" data-mask="99999-9999999-9" required />
													<span style="color: red; font-size: 12px;" id="cnicMsg"></span>
												</div>
											</div>
														...
														<div class="form-group has-feedback">
															<div class="col-md-2 m-b-5 col-md-offset-1">
																<select class="form-control" id="edit_appliance"
																	...
																	<option value="B1-Basic 1">B1-Basic 2</option>
