...
//            
//                else if(twentyWott==0)
//                {
//                	
//                	twentPerctage=0;
//                }else if(thirtyWott==0)
//                {
//                	thirtyPerctage=0;
//                }else if(fiftyWott==0)
//                {
...
//               var thirtyvot=data[0].ThirtyWott;
               ...
               Morris.Donut({element:"morris-donut-chart",data:[{label:"6 Watt",value:twentyWott},
           {label:"30 Watt",value:thirtyWott},{label:"60 Watt",value:fiftyWott}],
