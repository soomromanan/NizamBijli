...
handleFormPasswordIndicatorRepeat = function() {
	"use strict";
	$("#password-indicator-default-repeat").passwordStrengthRepeat(), $(
			"#password-indicator-visible-repeat").passwordStrengthRepeat({
...
handleJqueryAutocomplete = function() {
	var a = [ "ActionScript", "AppleScript", "Asp", "BASIC", "C", "C++",
	...
	return {
		init : function() {
			handleDatepicker(), handleIonRangeSlider(),
					handleFormMaskedInput(), handleFormColorPicker(),
					handleFormTimePicker(), handleFormPasswordIndicator(),
					handleFormPasswordIndicatorRepeat(),
					handleJqueryAutocomplete(), handleBootstrapCombobox(),
					handleSelectpicker(), handleTagsInput(),
					handleJqueryTagIt(), handleDateRangePicker(),
					handleSelect2()
		}
	}
}();