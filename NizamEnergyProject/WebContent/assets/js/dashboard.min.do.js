...
var handleMorrisDonusChart=function(){
	...
	$.ajax({
		...
		url : 'SuperAdminDashboardController',
			...
			dataType : 'json',
			data : {
				action : 'getDonutChartValues'
			},
		success : function(json){
			
			
           Morris.Donut({element:"morris-donut-chart",data:[{label:"50 Watt",value:json.data[1].appliancePercent},
       {label:"80 Watt",value:json.data[2].appliancePercent},{label:"100 Watt",value:json.data[0].appliancePercent}],
